    ...
    return (
        <>
            <div className='FD-1'>
                ...
                <span className='sub-head'>We ensure the best insurance services for our customer</span>
            ...
            <div className='plan-end'>
                ...
                <div className='plane-1'>
                    ...
                    <span className='plan-1'><strong> +10k</strong> </span>
                    <br></br>
                    <span >Active customer</span>

                </div>
                <div className='plane-2'>
                    <span className='plan-2'><strong> 95%</strong> </span>
                    <br></br>
                    <span > claims settlement ratio</span>
                </div>
                <div className='plane-3'>
                    <span className='plan-3'><strong> 100% </strong> </span>
                    <br></br>
